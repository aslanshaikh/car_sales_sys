...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 25, 2021 at 01:19 PM
...
-- Database: `check`
--
CREATE DATABASE IF NOT EXISTS `check` DEFAULT CHARACTER SET utf16 COLLATE utf16_general_ci;
USE `check`;

-- --------------------------------------------------------

--
-- Table structure for table `checki`
--
...
--
-- AUTO_INCREMENT for table `checki`
--
ALTER TABLE `checki`
...
-- Database: `college`
--
CREATE DATABASE IF NOT EXISTS `college` DEFAULT CHARACTER SET utf16 COLLATE utf16_general_ci;
USE `college`;
...
(1, 'chciken', 'chilli,butter', 'mumshaikh1234@gmail.com', '2021-12-10 10:08:14');
...
INSERT INTO `student` (`rollno`, `fname`, `lname`, `email`) VALUES
(102, 'John', 'Doe', 'jane@example.com');
...
-- Database: `crudyt`
--
CREATE DATABASE IF NOT EXISTS `crudyt` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `crudyt`;
...
(1, 'aslan', '1234'),
(2, 'aslan update', 'sdfghjkl'),
(3, 'aslan', '1234'),
(4, 'shk update', '6789ygduabcnc'),
(5, 'shaikh', '123456'),
(6, 'mumtaz', '567890');
...
('root', '[{\"db\":\"sessionpractical\",\"table\":\"signin\"},{\"db\":\"college\",\"table\":\"pizzas\"},{\"db\":\"college\",\"table\":\"student\"}]');
...
('root', '2021-12-19 16:29:43', '{\"Console\\/Mode\":\"collapse\"}');
...
--
CREATE DATABASE IF NOT EXISTS `sessionpractical` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
